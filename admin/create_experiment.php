...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $wpdb->query($wpdb->prepare("INSERT INTO ".$wpdb->prefix."WPTestMonkey_experiments SET name=%s, type=%s", $name, $type));
  $id = $wpdb->insert_id;
  ...
  // Insert goal
  $wpdb->query($wpdb->prepare("INSERT INTO ".$wpdb->prefix."WPTestMonkey_goals SET experiment_id=%d, name=%s", $id, 'Goal 1'));
