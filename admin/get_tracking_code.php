...
$id = (int)$_GET['id'];
$goal = $wpdb->get_row($wpdb->prepare("SELECT * FROM ".$wpdb->prefix."WPTestMonkey_goals WHERE id=%d", $id));
?>
...
<div class="wrap">
  ...
  <p style="margin-top: 5px;">
    <code>[WPTestMonkey goal="<?php echo $id ?>"]</code>
  </p>
  ...
  <p>
    &laquo; <a href="?page=WPTestMonkey&amp;action=show_experiment&amp;id=<?php echo $goal->experiment_id ?>">Back to experiment</a>
  </p>
</div>