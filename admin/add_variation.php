...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $wpdb->query($wpdb->prepare("INSERT INTO ".$wpdb->prefix."WPTestMonkey_variations SET experiment_id=%d, name=%s, content=%s", $experiment_id, $name, $content));
...
$exp = $wpdb->get_row($wpdb->prepare("SELECT * FROM ".$wpdb->prefix."WPTestMonkey_experiments WHERE id=%d", $experiment_id));
$themes = get_themes();
?>
...
<div class="wrap">
  ...
  <form method="post">
    ...
    <p>
      ...
      or <a href="?page=WPTestMonkey&amp;action=show_experiment&amp;id=<?php echo $experiment_id ?>">Cancel</a>
    </p>
  </form>
</div>
