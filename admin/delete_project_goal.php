...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  // Delete the goal
 // $wpdb->query($wpdb->prepare("DELETE FROM ".$wpdb->prefix."WPTestMonkey_project_goal_hits WHERE goal_id=%d", $id));
  $wpdb->query($wpdb->prepare("DELETE FROM ".$wpdb->prefix."WPTestMonkey_project_goals WHERE id=%d", $id));
...
<div class="wrap">
  <h3>Delete Project goal</h3>
  <form method="post">
    <p>
      Are you sure you want to delete the Project goal <em><?php echo htmlspecialchars($var->name) ?></em>? This can't be undone.
    </p>
    <p>
