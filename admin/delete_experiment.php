...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $wpdb->query($wpdb->prepare("DELETE FROM ".$wpdb->prefix."WPTestMonkey_goals WHERE experiment_id=%d", $id));
...
<div class="wrap">
  ...
  <form method="post">
    ...
    <p>
      ...
      or <a href="?page=WPTestMonkey&amp;action=show_experiment&amp;id=<?php echo $var->id ?>">Cancel</a>
    </p>
  </form>
</div>